...
print(len(Source))
print(len(Answer))
dataframe = pd.DataFrame({'Source sentence':Source,'Answer sentence':Answer})

#将DataFrame存储为csv,index表示是否显示行名，default=True
dataframe.to_csv("event_train.csv",index=False,sep=',',encoding = 'gbk')